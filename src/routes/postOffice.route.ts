import { createNewPost, getPostById, getPostByType, getPostOffices, getZonebyType, updatePost } from "@/controllers/postOffice.controller.js";
...
routePostOffice.get("/list/:type", getPostByType)
